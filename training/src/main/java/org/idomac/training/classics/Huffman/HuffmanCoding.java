...
public class HuffmanCoding {
     ...
     * 如果你得到的信息是百分比，乘以100或1000，或10000。总是可以转为整数。比如12.702%乘以1000为12702，
     * Huffman编码只关心大小问题。统计方法实现如下：
     * @param charArray
     * @return
     */
     ...
     * 反之如果是右节点，加1，直到根节点。只要获取了字符和二进制码之间的mapping关系，编码就非常简单。代码如下:
     * @param originalStr
     * @param statistics
     * @return
     */
     ...
     * 依次取出二进制的每一位，从树根向下搜索，1向右，0向左，到了叶子节点(命中)，退回根节点继续重复以上动作。代码如下:
     * @param binaryStr
     * @param statistics
     * @return
     */
